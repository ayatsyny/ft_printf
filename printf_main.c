...
* что бы не было много варнингов:)
* Кейн сравнивает вывод оригинального принтф и вашего, в верху майна можно
* указать точный путь к вашему ft_printf.h и можно выключить тесты которы вам не
*  нужны(коментите дефайны)
*/
